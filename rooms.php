    ...
    <div class="jumbotron" style="background-color: #0e0e0e; margin-top: -30px; margin-bottom: -80px;">
      ...
      <div class="jumbotron" style="background-color: #0e0e0e; margin-top: -30px;">
        ...
        ?>
            ...
            <div class="card mb-3" style="max-width: 650px; margin: 0 auto; background-color: #0e0e0e; color: white;border-color: #96E9C6; box-shadow: 0 0 15px #83C0C1;">
              ...
              <div class="card-body">
                ...
                <p class="card-text"><strong> SEATS: &nbsp;
                    <?php echo $row['seat_column'] * $row['seat_row']; //multiplying col and row to find total seats
                    ?></strong></p>
